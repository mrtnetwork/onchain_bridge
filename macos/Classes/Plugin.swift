...
public class OnChainBridgePlugin: NSObject, FlutterPlugin,MethodHandler {
    let serviceName = "com.mrtnetwork.onchain_bridge"
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "secureStorage":
            ...
            case "remove":
                ...
                break;
            case "readKeys":
                let prefix = args["key"] as? String
                let keys = readKeysWithPrefix(prefix)
                result(keys)
                break;
            case "containsKey":
                if let key: String = args["key"] as? String {
    ...
    func readKeysWithPrefix(_ prefix: String?) -> [String] {
        let query: [String: Any] = [
            kSecClass as String: kSecClassGenericPassword,
            kSecAttrService as String: serviceName,
