...
// class GrpcWebClient implements PlatformGrpc {
//   /// e.g. "https://your-grpc-web-endpoint:443"
//   final String baseUrl;
//   final Map<String, String>? extraHeaders;
//   final List<AbortController> _pendingAborts = [];

//   GrpcWebClient({required this.baseUrl, this.extraHeaders});
...
//       }
//       if (message == null) {
//         return Err(Ok(AppGrpcError(code: 13, message: 'no message in response')));
//       }
//       return Ok(message);
//     } catch (_) {
...
//             for (final f in decoder.drainFrames()) {
//               if (f.isTrailer) {
//                 final trailers = _parseTrailers(f.payload);
...
//           }
//         } catch (_) {
//           controller.addError(AppGrpcError(code: 14, message: 'stream failed'));
//         } finally {
//           reader.releaseLock();
//           _pendingAborts.remove(abort);
