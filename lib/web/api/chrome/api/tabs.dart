...
extension type Tabs._(JSObject _) {
  ...
  @JS("create")
  external JSPromise<ChromeTab> create(
      CreateTabProperties? createProperties, JSFunction? callback);
  @JS("update")
  external JSPromise<ChromeTab> update(
      int? tabId, UpdateTabProperties? updateProperties, JSFunction? callback);
...
extension type UpdateTabProperties._(JSObject o) implements JSObject {
  external UpdateTabProperties(
      {bool? active,
      bool? autoDiscardable,
      bool? highlighted,
      bool? muted,
