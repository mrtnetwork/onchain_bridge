...
typedef Sqlite3ColumnTypeNative = Int32 Function(Pointer<Void>, Int32);
typedef Sqlite3ColumnTypeDart = int Function(Pointer<Void>, int);
...
class SqlliteColumnInfo {
  ...
  final String name;
  final String type;
  const SqlliteColumnInfo(
      {required this.cid, required this.name, required this.type});
}
