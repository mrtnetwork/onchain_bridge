...
class WebViewIoInterface implements PlatformWebViewInterface {
  final IoNativeChannel channel;
  WebViewIoInterface(this.channel);
  ...
  Future<T> _call<T>({
    ...
    final result = await channel.channel.invokeMethod(
